...
class ImageUploader < CarrierWave::Uploader::Base
  ...
  def has_list_thumb? picture
    ['Project', 'Event', 'Activity', 'FundingInfo'].include?(model.class.name)
  end
  ...
  def has_top_internal? picture
    ['Mission', 'GovernancePage', 'ValuePage', 'FaqPage', 'CommunityPage', 'CocreationPage', 'ExpertGroupsPage', 'GetInvolvedPage', 'OrganizationPage', 'LivePage', 'PressRoomPage', 'FundedPage'].include?(model.class.name)
  end
end
