class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:email, :password, :password_confirmation, :name, :country, :language_id, :fname, :gender, :city, :occupation_id, :organization_name, :organization_url, :user_source_id, :birthday, {sector_ids: []})}
